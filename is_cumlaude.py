...
# Deskripsi : Fungsi yang menerima input a:float dan b:float dan mengembalikan nilai true jika 3.50<=ipk<=4.0 and waktu <= 54 
...
print(iscumlaude(1.0,54))
print(iscumlaude(4.0,60))